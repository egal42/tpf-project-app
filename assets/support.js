...
const FOREST_MESSAGES = [
  ...
  "One more seed finds its place.",
  "The path grows by one quiet step.",
  "A small signal becomes part of the forest.",
  "The roots remember more than words.",
  "Another branch of the journey begins.",
  "A quiet act joins the living ledger.",
  "The forest listens, and something grows.",
  "A small spark of green moves forward.",
  "The soil receives another promise.",
  "One step, one signal, one growing path.",
  "The forest does not rush, but it remembers.",
  "A new trace appears beneath the leaves.",
  "Another seed of action has been planted.",
  "The journey grows where care takes root.",
  "A quiet contribution enters the canopy.",
  "The roots stretch a little further.",
  "Another leaf turns toward the light.",
  "The forest carries this moment onward.",
  "A small step joins a larger story.",
  "The green path continues.",
  "The forest keeps the signal alive.",
  "One more mark in the living story.",
  "A gentle step, recorded in roots.",
  "The canopy grows from many small acts.",
  "The forest welcomes another quiet signal.",
  "A new root begins beneath the surface.",
  "The path through the forest becomes clearer.",
  "Something small has joined something lasting.",
  "Another moment becomes part of the grove.",
  "The forest grows through patient steps.",
  "A signal of support enters the leaves.",
  "This step now belongs to the forest.",
  "The living ledger gains another line.",
  "The roots carry this forward.",
  "A small action becomes part of the whole."
];
